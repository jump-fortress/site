<script>
  import overlay from '$lib/assets/static/logo/anim/small/overlay.png';
  import mask from '$lib/assets/static/logo/anim/small/mask.png';
  import bg from '$lib/assets/static/logo/anim/small/bg.png';
</script>
