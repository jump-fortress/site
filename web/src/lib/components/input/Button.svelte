...
<button
  class="relative flex h-10 w-fit cursor-pointer items-center rounded-box border-base-700 bg-base-800 px-2 transition-colors hover:border-content/50 hover:bg-base-900
