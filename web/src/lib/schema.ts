...
export interface components {
    schemas: {
        ...
        MOTW_Timeslot: {
             ...
             * Format: uri
             * @description A URL to the JSON Schema for this object.
             * @example https://example.com/schemas/MOTW_Timeslot.json
             */
            readonly $schema?: string;
            /** Format: int64 */
            id: number;
...
export type MotwTimeslot = components['schemas']['MOTW_Timeslot'];
...
export interface operations {
    ...
    "update-timeslot": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["MOTW_Timeslot"];
            };
        };
        responses: {
            /** @description No Content */
