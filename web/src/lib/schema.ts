...
export interface paths {
    ...
    "/internal/session/players/timeslot": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        TimeslotInfo: {
            ...
            timeslots: components["schemas"]["MOTWTimeslot"][] | null;
        };
    };
    responses: never;
    parameters: never;
...
export enum ApiPaths {
    ...
    get_timeslot = "/internal/session/players/timeslot",
