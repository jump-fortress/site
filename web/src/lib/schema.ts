...
export interface paths {
    ...
    "/internal/session/events/leaderboards/{leaderboard_id}/times/{duration}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export enum ApiPaths {
    ...
    submit_unverified_time = "/internal/session/events/leaderboards/{leaderboard_id}/times/{duration}",
