...
func registerOpenRoutes(internalApi *huma.Group) {
	...
	huma.Register(internalApi, huma.Operation{
		...
		Summary:     "get competition prizepool",
	...
	huma.Register(internalApi, huma.Operation{
		Method:      http.MethodGet,
		Path:        "/competitions/monthly/{id}",
		OperationID: "get-monthly",
		Summary:     "get monthly info",
...
func registerSessionRoutes(internalApi *huma.Group) {
	...
	huma.Register(internalApi, huma.Operation{
		...
		Summary:     "set preferred rocket launcher",
...
func registerAdminRoutes(adminApi *huma.Group) {
	...
	huma.Register(adminApi, huma.Operation{
		Method:      http.MethodPost,
		Path:        "/players/role/{id}/{role}",
		OperationID: "update-player-role",
		Summary:     "update player role",
		Description: "update a player's role",
		Tags:        []string{"Admin"},
		Security:    sessionCookieSecurityMap,
